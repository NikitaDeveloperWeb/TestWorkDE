...
var FIELD_MESSAGE = document.getElementById('message');
...
function validation() {
  ...
  var emailErr = true;
  var messageErr = true;
  var name = FIELD_NAME.value.trim();
  var email = FIELD_EMAIL.value.trim();
  var message = FIELD_MESSAGE.value.trim(); // Проверяем имя
...
function onSubmitForm() {
  if (validation()) {
    fetch('https://api.github.com/repos/javascript-tutorial/en.javascript.info/commits').then(notification());
  }
}

btn.addEventListener('click', onSubmitForm); // уведлмление об отправке формы
...
renderModal(); // fun for switch stet
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "03b5a1471b1bb1e7a929"; }
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "testworkde:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatetestworkde"] = function(chunkId, moreModules, runtime) {
